---
url: /docs-v1/guide/i18n.md
description: >-
  Set up internationalization (i18n) in  to support multiple languages for your
  site.
---
...
However,  won't redirect `/` to `/en/` by default. You'll need to configure your server for that. For example, on Netlify, you can add a `docs/public/_redirects` file like this:
