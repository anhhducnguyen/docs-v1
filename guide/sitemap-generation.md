---
url: /docs-v1/guide/sitemap-generation.md
description: >-
  Generate a sitemap.xml file for your  site to improve search engine
  discoverability.
---

# Sitemap Generation

comes with out-of-the-box support for generating a `sitemap.xml` file for your site. To enable it, add the following to your `.vitepress/config.js`:
