---
description: Aprende cómo usar frontmatter YAML en archivos Markdown de  para controlar los metadatos y el comportamiento a nivel de página.
---
...
## Formatos Alternativos del Frontmatter {#alternative-frontmatter-formats}
 ...
 también soporta la sintaxis frontmatter JSON, comenzando y terminando con llaves:
