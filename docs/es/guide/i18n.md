---
description: Configura la internacionalización (i18n) en  para soportar múltiples idiomas en tu sitio.
---
...
Sin embargo,  no redireccionará `/` para `/en/` por defecto. Necesitará configurar su servidor para esto. Por ejemplo, en Netlify, puede adicionar un archivo `docs/public/_redirects` asi:
