---
description: Elige entre los layouts doc, page y home en el tema predeterminado de .
---
...
El layout de la página le permitirá diseñar todo sin que el tema de  afecte el marcado. Esto es útil cuando desea crear su propia página personalizada.
