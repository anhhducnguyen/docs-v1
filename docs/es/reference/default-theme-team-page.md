---
description: Crea páginas de equipo con perfiles de miembros usando los componentes de equipo integrados de .
---
...
<VPTeamPage>
  <VPTeamPageTitle>
    ...
    <template #lead>
      El desarrollo de  está guiado por un equipo internacional,
