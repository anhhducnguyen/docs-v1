---
description: Создавайте страницы команды с профилями участников, используя встроенные компоненты .
---
...
<VPTeamPage>
  <VPTeamPageTitle>
    ...
    <template #lead>
      Разработкой  руководит международная команда, некоторые члены
