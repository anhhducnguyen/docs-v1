---
description: Настройте панель навигации в теме  по умолчанию, включая заголовок сайта, логотип и ссылки меню.
---
...
По умолчанию  автоматически определяет атрибуты `target` и `rel` в зависимости от того, является ли ссылка внешней. Но при желании их можно настроить и вручную.
...
Ваш компонент будет отображаться на панели навигации.  предоставляет следующие дополнительные параметры компонента:
