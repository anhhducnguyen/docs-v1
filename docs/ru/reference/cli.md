---
description: Справочник по командам CLI , включая dev, build, preview и init.
---
...
Запуск сервера разработки , с использованием указанного каталога в качестве корневого. По умолчанию используется текущий каталог. Команду `dev` также можно опустить при работе в текущем каталоге.
...
Создание производственной сборки текущего сайта .
