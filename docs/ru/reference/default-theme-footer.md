---
description: Настройте глобальный футер, отображаемый в нижней части страниц .
---

# Футер {#footer}

 будет отображать блок футера внизу страницы, если присутствует объект `themeConfig.footer`.
