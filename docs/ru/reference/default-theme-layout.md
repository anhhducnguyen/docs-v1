---
description: Выбирайте между макетами doc, page и home в теме  по умолчанию.
---
...
Макет `page` позволит вам оформить всё самостоятельно, без влияния темы  на разметку. Это удобно, когда вы хотите создать свою собственную страницу.
