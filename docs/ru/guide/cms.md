---
description: Подключите  к безголовой CMS с помощью динамических маршрутов и загрузчиков данных.
outline: deep
---
...
Подключение  к CMS в значительной степени зависит от [динамических маршрутов](./routing#dynamic-routes). Прежде чем приступить к работе, убедитесь, что вы понимаете, как это работает.
...
Если вы написали руководство по интеграции  с конкретной CMS, воспользуйтесь ссылкой «Редактировать эту страницу», чтобы добавить его сюда!
