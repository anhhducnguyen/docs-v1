---
description: Узнайте, как использовать метаданные YAML в Markdown-файлах  для управления метаданными и поведением на уровне страниц.
---
...
## Альтернативные форматы метаданных {#alternative-frontmatter-formats}
 ...
 также поддерживает синтаксис метаданных JSON, начинающийся и заканчивающийся фигурными скобками:
