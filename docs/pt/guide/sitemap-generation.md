---
description: Gere um arquivo sitemap.xml para seu site  e melhore a descoberta por motores de busca.
---

# Geração de Sitemap {#sitemap-generation}

 vem com suporte embutido para gerar um arquivo `sitemap.xml` para seu site. Para habilitar, adicione o seguinte ao seu `.vitepress/config.js`:
