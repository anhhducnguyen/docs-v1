---
url: /docs-v1/reference/default-theme-sidebar.md
description: >-
  Configure the sidebar navigation in the  default theme with groups,
  collapsible sections, and multiple sidebars.
---
